...
public class FaceActivity extends AppCompatActivity {
    ...
    private float[] lrpFeature = new float[]{0.0017704667f,0.20375536f,0.05408172f,0.04660603f,0.023172157f,-0.05742263f,0.09376469f,0.14228868f,-0.029499209f,-0.007082505f,-0.13707162f,0.07870435f,-0.14371331f,0.08296078f,-0.10370595f,-0.17017254f,-0.17897788f,-0.028355205f,-0.115985274f,0.098345995f,0.0602043f,0.013312974f,0.09513563f,0.049428172f,4.3101766E-4f,0.09292531f,-0.036146168f,-0.037626933f,-0.07893217f,0.05992858f,-0.007997538f,0.043173645f,-0.15043102f,-0.004721517f,0.07391314f,-0.037418526f,0.11827091f,-0.1467674f,-0.016801918f,-0.0033222542f,-0.033692595f,0.03463479f,0.022172228f,-0.025855629f,-0.037195265f,-0.05013139f,0.05464309f,-0.03014696f,0.12532137f,0.0020451853f,-0.08703451f,-0.012512541f,-0.0758989f,0.0031022364f,-0.035318278f,0.12052521f,0.050227858f,0.033058915f,-0.061979435f,0.056204636f,-0.1234747f,-0.053606484f,-0.01454873f,0.11265107f,0.1513107f,-0.10724516f,0.06389151f,-0.11516642f,0.072335996f,-0.0034912338f,-0.018062353f,-0.0446271f,0.09288555f,0.11529272f,0.25168815f,-0.05047741f,-0.05193353f,0.090689875f,-0.05081874f,-0.0073672924f,0.0807255f,-0.20883109f,0.012775217f,-0.1640329f,0.10064726f,-0.07651347f,0.045972638f,0.019586015f,-0.1124318f,0.0378681f,0.052336734f,-0.024122491f,0.12781633f,0.07464837f,0.029496757f,-0.049273018f,-0.02467848f,-0.04275621f,-0.12762995f,-0.11310931f,-0.06465519f,0.10892642f,0.0026303595f,-0.111214384f,-0.107084185f,0.105247945f,0.09892605f,-0.013067529f,-0.08007214f,0.03844513f,-0.07662577f,0.07062439f,0.068140686f,-0.113650724f,-0.05743408f,0.15497968f,0.031545676f,0.0040626037f,-0.113801196f,-0.10349347f,-0.20273419f,0.0020015128f,0.019439029f,-0.12690872f,0.0947906f,0.09424289f,0.09736695f,0.07148609f};
...
//        Log.d(TAG, "byteArr2BitmapAndLogRecognizeResult: 人脸特征提取完成");
        ...
        boolean lrpFlag = mFaceRecognize.compare(features, lrpFeature) >= threshold;
        if (lrpFlag) {
            preFeature = lrpFeature;
            preFaceName = "梁润鹏";
            tv_res.setText(preFaceName);
            return;
        }
