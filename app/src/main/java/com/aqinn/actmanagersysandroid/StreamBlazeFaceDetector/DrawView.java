...
import com.aqinn.actmanagersysandroid.ImageInfo;
import com.aqinn.actmanagersysandroid.ObjectInfo;
...
{
    private static String TAG = com.aqinn.actmanagersysandroid.StreamBlazeFaceDetector.DrawView.class.getSimpleName();
